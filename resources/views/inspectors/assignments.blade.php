                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                    @forelse($allAssignments as $request)
                        <tr>
                            ...
                            <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{ $request->updated_at ? $request->updated_at->format('M d, Y') : '-' }}</td>
                            <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                                ...
                                @elseif ($request->status === 'in_progress')
                                    <div class="flex items-center space-x-2">
                                        <a href="{{ route('inspector.requests.show', $request->id) }}" class="inline-block bg-indigo-500 hover:bg-indigo-700 text-white text-xs font-semibold px-4 py-2 rounded">
                                            <svg class="w-4 h-4 mr-1.5 inline" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 010-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178z" />
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                            </svg>
                                            View Request
