...
@section('content')
    ...
    <div class="overflow-x-auto">
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                    @forelse($completedRequests as $request)
                        <tr>
                            ...
                            <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{ $request->completed_at ? $request->completed_at->format('M d, Y') : '-' }}</td>
        ...
        @endif
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-6 text-center">No completed requests found.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
