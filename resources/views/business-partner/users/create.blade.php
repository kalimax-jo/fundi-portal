...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-600">Add a new user or client to {{ $partner->name }}</p>
                    </div>
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <form method="POST" action="{{ route('business-partner.users.store') }}" class="p-6">
                @csrf
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-blue-50 border border-blue-200 rounded-md p-4">
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    <h3 class="text-sm font-medium text-blue-800">Role Information</h3>
                                    <div class="mt-2 text-sm text-blue-700">
                                        <ul class="list-disc pl-5 space-y-1">
                                            <li><strong>Institutional Partner:</strong> Can manage users, properties, and requests</li>
                                            <li><strong>Client:</strong> Can view their own properties and request inspections</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
