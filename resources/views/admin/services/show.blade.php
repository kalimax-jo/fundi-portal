            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="bg-gray-50 rounded-lg p-4">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <dt class="text-sm font-medium text-gray-500">Critical Findings</dt>
                            <dd class="text-lg font-medium text-gray-900">{{ $usageStats['critical_findings'] }}</dd>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 rounded-lg p-4">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <dt class="text-sm font-medium text-gray-500">Critical Rate</dt>
                            <dd class="text-lg font-medium text-gray-9">{{ $usageStats['critical_rate'] }}%</dd>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 rounded-lg p-4">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <dd class="text-lg font-medium text-gray-900">{{ $usageStats['this_month_inspections'] }}</dd>
                        </div>
                    </div>
                </div>
            </div>
