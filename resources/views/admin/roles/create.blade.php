...
<div class="max-w-4xl mx-auto">
    <form action="{{ route('admin.roles.store') }}" method="POST" class="space-y-8">
        ...
        <div class="bg-white shadow px-4 py-5 sm:rounded-lg sm:p-6">
            <div class="md:grid md:grid-cols-3 md:gap-6">
                <div class="md:col-span-1">
                    ...
                    <p class="mt-1 text-sm text-gray-500">Define the role name, display name, and description.</p>
                </div>
                    ...
                    <div class="grid grid-cols-6 gap-6">
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name') }}" required
                                   ...
                                   class="mt-1 block w-full px-3 py-2 bg-white border border-gray-300 rounded-md text-sm shadow-sm placeholder-gray-400 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 @error('name') border-red-300 focus:border-red-500 focus:ring-red-500 @enderror">
                        ...
                        <div class="col-span-6">
                            ...
                            <textarea name="description" id="description" rows="3"
                                      ...
                                      class="mt-1 block w-full px-3 py-2 bg-white border border-gray-300 rounded-md text-sm shadow-sm placeholder-gray-400 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 @error('description') border-red-300 focus:border-red-500 focus:ring-red-500 @enderror">{{ old('description') }}</textarea>
                            @error('description')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
        ...
        <div class="bg-white shadow px-4 py-5 sm:rounded-lg sm:p-6">
            <div class="md:grid md:grid-cols-3 md:gap-6">
                <div class="md:col-span-1">
                    ...
                    <p class="mt-1 text-sm text-gray-500">Select the permissions that users with this role will have.</p>
        ...
        <div class="bg-gray-50 shadow px-4 py-5 sm:rounded-lg sm:p-6">
            <h3 class="text-lg font-medium leading-6 text-gray-900 mb-4">Role Preview</h3>
            <div class="bg-white rounded-lg border border-gray-200 p-4">
                <div class="flex items-start">
                    ...
                    <div class="ml-4 flex-1">
                        <p class="text-sm font-medium text-gray-900" id="preview-display-name">
                            <span class="text-gray-400">Display Name will appear here</span>
                        </p>
                        <p class="text-sm text-gray-500" id="preview-name">
                            <span class="text-gray-400">role_name</span>
                        </p>
                        <p class="text-sm text-gray-600 mt-1" id="preview-description">
                            <span class="text-gray-400">Description will appear here</span>
                        </p>
                        <div class="mt-2">
                            <span class="text-xs text-gray-500">Permissions: </span>
                            <span id="preview-permissions-count" class="text-xs font-medium text-indigo-600">0 selected</span>
                        </div>
                    </div>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updatePreview() {
        // Update display name
        const displayName = displayNameInput.value || 'Display Name will appear here';
        document.getElementById('preview-display-name').innerHTML = 
            displayName === 'Display Name will appear here' ? 
            '<span class="text-gray-400">' + displayName + '</span>' : displayName;
        
        // Update role name
        const roleName = nameInput.value || 'role_name';
        document.getElementById('preview-name').innerHTML = 
            roleName === 'role_name' ? 
            '<span class="text-gray-400">' + roleName + '</span>' : roleName;
